//
//  AddEnterprisePlanViewController.h
//  eia
//
...
@interface AddEnterprisePlanViewController : InheritanceViewController<UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate>
