//
//  EnterprisesDetailNoProductionViewController.h
//  eia
//
...
#import "EnterpriseInformationTopView.h"
...
@interface EnterprisesDetailNoProductionViewController : PageViewController<UIScrollViewDelegate>


@property (nonatomic, strong) NSString *Id;

@property (nonatomic, strong) EnterpriseInformationTopView *enterpriseInformationTopView;
